...
class UDPMultiTopicServerNode(Node):
    def __init__(self):
        super().__init__('udp_supercapacitor_server')
        ...
        module_name = os.getenv('MODULE_NAME', 'supercapacitor')
        try:
    ...
    def receive_message(self):
        ...
        try:
            ...
            try:
                ...
                # Publish to module-specific topic (e.g., supercapacitor/voltage/phase1)
                module_topic = f"/ros2mqtt/{os.getenv('MODULE_NAME', 'supercapacitor')}/voltage/phase1"
                if module_topic in self.publishers:
                    ...
                    # Publish to MQTT
                    mqtt_topic = f"phil/{os.getenv('MODULE_NAME', 'supercapacitor')}/voltage/phase1"
