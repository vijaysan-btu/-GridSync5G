%% Distributed Swing Equation Test Execution Script
clc
gui = GUIRemote();
...
run('parameters_swing_test.m') % Ensure Control_Strategy = 3
...
gui.setparam(fc, "INV.enable_powerPI", 0)
...
pause(3)
gui.setparam(bat, "INV.EL.Pref", -10000)
pause(5)
...
P1 = 2000; % Approximate
P2 = 3000;
P3_star = INV.DG3.Kt * (P_load - (P1 + P2)/2); % Consensus average
...
disp('Distributed swing test completed.')