%% Decentralized Swing Equation Test Execution Script
clc
gui = GUIRemote();
...
run('parameters_swing_test.m') % Ensure Control_Strategy = 2
...
P_load = -10000;
P3_star = INV.DG3.Kt * P_load; % Local estimation
...
disp('Decentralized swing test completed.')